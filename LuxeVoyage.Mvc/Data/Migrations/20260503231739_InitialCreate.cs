        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationLabel = table.Column<string>(type: "TEXT", maxLength: 120, nullable: true),
                    Rating = table.Column<double>(type: "REAL", nullable: true),
                    PriceHint = table.Column<string>(type: "TEXT", maxLength: 60, nullable: true),
                    BreadcrumbRegion = table.Column<string>(type: "TEXT", maxLength: 80, nullable: true),
                    BreadcrumbCity = table.Column<string>(type: "TEXT", maxLength: 80, nullable: true),
                    BreadcrumbCurrent = table.Column<string>(type: "TEXT", maxLength: 80, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Region = table.Column<int>(type: "INTEGER", nullable: false),
                    CityLine = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    ImageUrl = table.Column<string>(type: "TEXT", maxLength: 400, nullable: true),
                    AmenitiesCsv = table.Column<string>(type: "TEXT", maxLength: 400, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryLabel = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
                    ImageUrl = table.Column<string>(type: "TEXT", maxLength: 400, nullable: true),
                    Summary = table.Column<string>(type: "TEXT", maxLength: 600, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_UserId_TargetKind_TargetId",
                table: "Favorites",
                columns: new[] { "UserId", "TargetKind", "TargetId" },
                unique: true);
